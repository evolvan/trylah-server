...
export class CancelActiveOrderError extends ErrorResult {
    ...
    constructor(public orderState: Scalars['String']) {
        super()
    }
}
...
export class ChannelDefaultLanguageError extends ErrorResult {
    ...
    constructor(public channelCode: Scalars['String'], public language: Scalars['String']) {
        super()
    }
}
...
export class CreateFulfillmentError extends ErrorResult {
    ...
    constructor(public fulfillmentHandlerError: Scalars['String']) {
        super()
    }
}
...
export class LanguageNotAvailableError extends ErrorResult {
    ...
    constructor(public languageCode: Scalars['String']) {
        super()
    }
}
...
export class MimeTypeError extends ErrorResult {
    ...
    constructor(public fileName: Scalars['String'], public mimeType: Scalars['String']) {
        super()
    }
}
