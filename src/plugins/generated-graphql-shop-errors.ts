...
export class CouponCodeExpiredError extends ErrorResult {
    ...
    constructor(public couponCode: Scalars['String']) {
        super()
    }
}
...
export class CouponCodeLimitError extends ErrorResult {
    ...
    constructor(public couponCode: Scalars['String'], public limit: Scalars['Int']) {
        super()
    }
}
...
export class IneligiblePaymentMethodError extends ErrorResult {
    ...
    constructor(public eligibilityCheckerMessage: any) {
        super()
    }
}
...
export class InsufficientStockError extends ErrorResult {
    ...
    constructor(public order: any, public quantityAvailable: Scalars['Int']) {
        super()
    }
}
...
export class InvalidCredentialsError extends ErrorResult {
    ...
    constructor(public authenticationError: Scalars['String']) {
        super()
    }
}
...
export class OrderLimitError extends ErrorResult {
    ...
    constructor(public maxItems: Scalars['Int']) {
        super()
    }
}
...
export class PaymentDeclinedError extends ErrorResult {
    ...
    constructor(public paymentErrorMessage: Scalars['String']) {
        super()
    }
}
...
export class PhoneNumberInvalidError extends ErrorResult {
    readonly __typename = 'PhoneNumberInvalidError'
    readonly errorCode = 'PHONE_NUMBER_INVALID_ERROR' as any
    readonly message = 'PHONE_NUMBER_INVALID_ERROR'
    constructor() {
        super()
    }
}

export class SmsOtpExpiredError extends ErrorResult {
    readonly __typename = 'SmsOtpExpiredError'
    readonly errorCode = 'SMS_OTP_EXPIRED_ERROR' as any
    readonly message = 'SMS_OTP_EXPIRED_ERROR'
    constructor() {
        super()
    }
}

export class SmsOtpInvalidError extends ErrorResult {
    readonly __typename = 'SmsOtpInvalidError'
    readonly errorCode = 'SMS_OTP_INVALID_ERROR' as any
    readonly message = 'SMS_OTP_INVALID_ERROR'
    constructor() {
        super()
    }
}
